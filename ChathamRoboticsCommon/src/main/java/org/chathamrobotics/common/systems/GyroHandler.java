...
public class GyroHandler implements System {
     ...
     */
    public static double relativeAngle(double referenceAngle, double angle, @NonNull AngleUnit angleUnit) {
    ...
    public static double angularDisplacement(double initialAngle, double finalAngle, @NonNull AngleUnit angleUnit) {
        return (finalAngle - initialAngle + angleUnit.fromDegrees(180)) % angleUnit.fromDegrees(360) - angleUnit.fromDegrees(180);
    }
