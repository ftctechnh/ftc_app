...
public class DetectorParameters {
    ...
    public  boolean get_doCornerRefinement()
    {
        ...
        boolean retVal = get_doCornerRefinement_0(nativeObj);
    ...
    public  void set_doCornerRefinement(boolean doCornerRefinement)
    {
        ...
        set_doCornerRefinement_0(nativeObj, doCornerRefinement);
    ...
    // C++: bool DetectorParameters::doCornerRefinement
    private static native boolean get_doCornerRefinement_0(long nativeObj);

    // C++: void DetectorParameters::doCornerRefinement
    private static native void set_doCornerRefinement_0(long nativeObj, boolean doCornerRefinement);
