...
public class AutoBlueRight extends LinearOpMode {
    ...
    @Override
    public void runOpMode() throws InterruptedException { //This class has class. :)
        ...
        while (opModeIsActive())
        {
            ...
            { // Test to see if Image is the "LEFT" image and display value.
                ...
                telemetry.update();
                myRobot.drive(0.1,0.1, 1050);
                sleep(100);
                myRobot.drive(-1, 1, 1000);
                sleep(100);
                myRobot.drive(0.01, 0.01, 1000);
                sleep(100);
                myRobot.claw_release();
                sleep(100);
                myRobot.drive(-0.1, -0.1, 500);
                myRobot.stop();
                sleep(30000);
