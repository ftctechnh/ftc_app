...
public class Teleop extends OpMode {
    ...
    public void loop() {
        ...
        */
        ...
        telemetry.addData("Lift Left", BotHardware.Motor.liftLeft.motor.getCurrentPosition());
        telemetry.addData("Lift Right", BotHardware.Motor.liftRight.motor.getCurrentPosition());
    }
