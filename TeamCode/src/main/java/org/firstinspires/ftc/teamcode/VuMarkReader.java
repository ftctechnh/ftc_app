...
public class VuMarkReader {
    ...
    VuMarkReader(LinearOpMode autonomousMode, Telemetry telemetry) {
    ...
    void init() {
         ...
         */
        int cameraMonitorViewId = autonomousMode.hardwareMap.appContext.getResources()
                .getIdentifier("cameraMonitorViewId", "id", autonomousMode.hardwareMap.appContext.getPackageName());
     ...
     */
    RelicRecoveryVuMark vuMarkIdentificationTask() {
