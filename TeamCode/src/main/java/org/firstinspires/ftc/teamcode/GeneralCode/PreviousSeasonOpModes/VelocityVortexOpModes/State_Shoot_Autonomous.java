...
public class State_Shoot_Autonomous extends LinearOpMode {
    ...
    public void align(){
        ...
        fright.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        fright.setTargetPosition( (int) Math.floor( 210 * (distance / 2.54 - 3)));
        fright.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        fleft.setTargetPosition( (int) Math.floor( 210 * (distance / 2.54 - 3)));
