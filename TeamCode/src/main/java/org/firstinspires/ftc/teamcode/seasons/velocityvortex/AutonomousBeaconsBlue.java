...
public class AutonomousBeaconsBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.getFrontRightDrive().setTargetPosition(-ZoidbergHardware.COUNTS_PER_INCH * 79);
        robot.getBackLeftDrive().setTargetPosition(ZoidbergHardware.COUNTS_PER_INCH * 79);
        ...
        while(opModeIsActive()
                && robot.getFrontRightDrive().isBusy()
                && robot.getBackLeftDrive().isBusy()) {
            ...
            telemetry.addData("front left target", robot.getFrontRightDrive().getTargetPosition());
            telemetry.addData("back right target", robot.getBackLeftDrive().getTargetPosition());
            telemetry.update();
            idle();
        }
