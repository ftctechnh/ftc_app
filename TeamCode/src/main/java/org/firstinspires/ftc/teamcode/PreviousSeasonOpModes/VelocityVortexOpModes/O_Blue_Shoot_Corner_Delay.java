...
@Disabled
@Autonomous(name = "O_Delay_Blue_Shoot_Corner", group = "Autonomous")
public class O_Blue_Shoot_Corner_Delay extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //15 second delay
        robot.timer.reset();
        while(robot.timer.seconds() < 15 && opModeIsActive()){}
