...
//        }
        ...
        if(isStoneRed){
            if(isLeftStone){
                telemetry.addData(">", "Running Red Left Program.");
                telemetry.update();
                redLeft(robot);
            } else {
                telemetry.addData(">", "Running Red Right Program.");
                telemetry.update();
                redRight(robot);
            }
        } else {
            if(isLeftStone){
                telemetry.addData(">", "Running Blue Left Program.");
                telemetry.update();
                blueLeft(robot);
            } else {
                telemetry.addData(">", "Running Blue Right Program.");
                telemetry.update();
                blueRight(robot);
            }
        }
