...
in here: frontMax, rearMax (to avoid overdriving)
in HardwareBruinBot: public static final double ARM_EXT_SERVO
know what type of motor/servo the extension is going to be!
 */
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            armPower = -gamepad2.left_stick_y;  // Negative because the gamepad is weird
            /*
            make sure that frontMax and rearMax is fixed to avoid overdriving
             */
            //strafe = gamepad1.left_stick_x;
            //rotate = gamepad1.right_stick_x;
            //frontMax = Math.max(Math.abs(armPower); //needs to be changed later
