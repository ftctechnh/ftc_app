...
public class MouseFan extends OpMode {
    ...
    private final Context context = FtcRobotControllerActivity.getAppContext();
    ...
    private void transfer(UsbDevice device) {
        ...
        connection = this.usbManager.openDevice(device);
