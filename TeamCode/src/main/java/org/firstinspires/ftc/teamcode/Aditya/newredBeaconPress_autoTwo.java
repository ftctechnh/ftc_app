...
public class newredBeaconPress_autoTwo extends AutonomousGeneral {
    ...
    public void runOpMode() {
      ...
      //  encoderDrive(0.3, 125.7, 125.7, 8.0);  // S1: Forward 47 Inches with 5 Sec timeout
      //  encoderDrive(0.4,12.5,-12.5,5);
...
/*
    ...
    public void pressBeacon() {
        ...
        telemetry.addData("","allignRangeDist(19.1)");
        telemetry.update();
        allignRangeDist(7);
        //sleep(5000);
