...
public class RedRedemption extends AutonomousBase
{
    ...
    protected void driverStationSaysGO() throws InterruptedException
    {
        ...
        driveUntilDistanceFromObstacle (32);
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            while (bottomColorSensor.alpha() <= 5)
            {
                ...
                //Scrub the input (if 255 it's invalid)
            ...
            while (! (option1Red && option2Red))
            {
                ...
                if (option1Red && option2Blue)
                {
                    ...
                    driveForDistance (0.27, 160 + 10 * failedAttempts);
                    pressButton();
                ...
                else if (option1Blue && option2Red)
                {
                    ...
                    driveForDistance (-0.27, 60 + 10 * failedAttempts);
                    pressButton();
