...
public class VuforiaSquirrelyDriveTestOp extends OpMode {
    ...
    public void init() {
        ...
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-1500,300,targetZ), mVLib, mVLib, mMotors, power, error));    // Wheels
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-1500,-914,targetZ), mVLib, mVLib, mMotors, power, error));   // Legos
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-914,-1500,targetZ), mVLib, mVLib, mMotors, power, error));   // Tools
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(300,-1500,targetZ), mVLib, mVLib, mMotors, power, error));    // Gears

        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(0,0,targetZ), mVLib, mVLib, mMotors, power, error));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-1000,0,targetZ), mVLib, mVLib, mMotors, power, error));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-1000,-1000,targetZ), mVLib, mVLib, mMotors, power, error));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(0,-1000,targetZ), mVLib, mVLib, mMotors, power, error));
