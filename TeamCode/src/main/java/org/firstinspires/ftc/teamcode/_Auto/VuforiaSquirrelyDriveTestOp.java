...
public class VuforiaSquirrelyDriveTestOp extends OpMode {
    ...
    public void init() {
        ...
        float power = 1.0f;
        float inches = 25.4f;
        float error = 4*25.4f;       // get us within 4" for this test
        float targetZ = 0*25.4f;    // since we put the height of the camera into the Vuforia camera position matrix, the Z value of the robot is zero
        boolean stop = true;
        double pauseSec = 4.0;
        ...
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-64*inches,12*inches,targetZ), mVLib, mVLib, mMotors, power, error, stop));    // Wheels
        mSequence.add(new AutoLib.LogTimeStep(this, "at Wheels", pauseSec));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-64*inches,-36*inches,targetZ), mVLib, mVLib, mMotors, power, error, stop));   // Legos
        mSequence.add(new AutoLib.LogTimeStep(this, "at Legos", pauseSec));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-36*inches,-64*inches,targetZ), mVLib, mVLib, mMotors, power, error, stop));   // Tools
        mSequence.add(new AutoLib.LogTimeStep(this, "at Tools", pauseSec));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(12*inches,-64*inches,targetZ), mVLib, mVLib, mMotors, power, error, stop));    // Gears
        mSequence.add(new AutoLib.LogTimeStep(this, "at Gears", pauseSec));

        //mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(0,0,targetZ), mVLib, mVLib, mMotors, power, error));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-1000,0,targetZ), mVLib, mVLib, mMotors, power, error, stop));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(-1000,-1000,targetZ), mVLib, mVLib, mMotors, power, error, stop));
        mSequence.add(new AutoLib.VuforiaSquirrelyDriveStep(this, new VectorF(0,-1000,targetZ), mVLib, mVLib, mMotors, power, error, stop));
