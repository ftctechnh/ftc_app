...
public class SouthBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        jeffThePengwin.backToPosition(26,0.4);
        runtime.reset();
        while(runtime.seconds()<5 && opModeIsActive()&& jeffThePengwin.isMoving()){
            //Do Nothing
        }
        //
        jeffThePengwin.leftToPosition(12,0.75);
        runtime.reset();
        while(runtime.seconds()<6 && opModeIsActive() && jeffThePengwin.isMoving()){
            //Do Nothing
        }
        gentlyPutTheMotorsToSleep();
        //
        jeffThePengwin.backToPosition(8,0.4);
        runtime.reset();
        ...
        gentlyPutTheMotorsToSleep();
        //
        jeffThePengwin.turnRightToPostion(49, 0.4);
        runtime.reset();
        while(runtime.seconds()<6 && opModeIsActive() && jeffThePengwin.isMoving()){
            //Do Nothing
        }
