    ...
    public void loop() {
        ...
        if (!gamepad1.atRest()) {
            ...
            if (gamepad2.right_bumper || gamepad2.left_bumper) {
                drive.driveLeftRight(-gamepad2.right_stick_x/4, -gamepad2.left_stick_x/4, -gamepad2.right_stick_y/4, -gamepad2.left_stick_y/4);
            } else {
                drive.driveLeftRight(-gamepad2.right_stick_x, -gamepad2.left_stick_x, -gamepad2.right_stick_y, -gamepad2.left_stick_y);
            }
        } else {
            drive.stop();
        }
