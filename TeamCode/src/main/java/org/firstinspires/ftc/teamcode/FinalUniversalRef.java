        ...
        switch (colorOfPlatform)
        {
            case 'b':
                ...
                switch (colorOfJewel)
                {
                    ...
                    case 'b':
                        ...
                        newRobot.moveWing(false);
                        newRobot.driveStraight_In(adjustment + 8);
                        break;
                    default:
                        newRobot.moveWing(false);
                        newRobot.driveStraight_In(7);
                        break;
                }
                ...
                switch (cipher)
                {
                    case 'r':
                        newRobot.pivot(50,.6);
                        newRobot.driveStraight_In(18.5f, .5);
                        newRobot.openOrCloseDoor(false);
                        newRobot.driveStraight_In_Stall(18.5f, .5, telemetry);
                        break;
                    case 'c':
                        newRobot.pivot(50,.6);
                        newRobot.driveStraight_In(18.5f, .5);
                    ...
                    case 'l':
                        newRobot.pivot(20,.6);
                        newRobot.driveStraight_In(15, .5);
                        newRobot.openOrCloseDoor(false);
            ...
            case 'r':
                ...
                switch (cipher)
                {
                    ...
                    default:
                        newRobot.pivot(35,.6);
                        newRobot.driveStraight_In(17, .5);
                        newRobot.openOrCloseDoor(false);
                        newRobot.driveStraight_In_Stall(17, .5, telemetry);
                        break;
                }
