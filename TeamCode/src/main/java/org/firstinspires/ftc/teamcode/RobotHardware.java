...

{
...

    {
        ...
        // the FTC RobotTeleOp Controller (Settings-->Configure RobotTeleOp).
        //
    ...
    {
        if (v_motor_left_drive_front != null && v_motor_right_drive_back != null)
        {
            v_motor_left_drive_front.setMode
                    ( DcMotorController.RunMode.RUN_USING_ENCODERS
                    );
            v_motor_left_drive_back.setMode
                    (DcMotorController.RunMode.RUN_USING_ENCODERS
                    );
        }
...

    {
        if (v_motor_right_drive_front != null && v_motor_right_drive_back != null)
        {
            v_motor_right_drive_front.setMode
                    ( DcMotorController.RunMode.RUN_USING_ENCODERS
                    );
            v_motor_right_drive_back.setMode
                    ( DcMotorController.RunMode.RUN_USING_ENCODERS
                    );
        }
...

    {
        if (v_motor_left_drive_front != null && v_motor_left_drive_back != null)
        {
            if (v_motor_left_drive_front.getMode() == DcMotorController.RunMode.RESET_ENCODERS && v_motor_left_drive_back.getMode() == DcMotorController.RunMode.RESET_ENCODERS)
            {
                v_motor_left_drive_front.setMode
...

    {
        if (v_motor_right_drive_front != null && v_motor_right_drive_back != null)
        {
            if (v_motor_right_drive_front.getMode() == DcMotorController.RunMode.RESET_ENCODERS && v_motor_right_drive_back.getMode() == DcMotorController.RunMode.RESET_ENCODERS)
            {
                v_motor_right_drive_front.setMode
                        ( DcMotorController.RunMode.RUN_WITHOUT_ENCODERS
                        );
