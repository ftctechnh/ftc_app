...
public class State_Shoot_Park_Blue extends LinearOpMode {
    ...
    public void lineUp(int direction) {
        fleft.setPower(driveSpeed * .75 * direction);
        bleft.setPower(driveSpeed * .75 * direction);
        fright.setPower(driveSpeed * .75 * direction);
        bright.setPower(driveSpeed * .75 * direction);
    ...
    public void align(){
        ...
        fright.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        fright.setTargetPosition( (int) Math.floor( 210 * (distance / 2.54 - 2.8)));
        fright.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        fleft.setTargetPosition( (int) Math.floor( 210 * (distance / 2.54 - 2.8)));
