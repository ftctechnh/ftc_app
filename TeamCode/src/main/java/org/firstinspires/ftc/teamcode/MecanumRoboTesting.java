...
/**
 * Created by Recharged Orange on 10/1/2018.
 */

@Autonomous(name = "mecanum Robo Testing")

public class MecanumRoboTesting extends linearOpmode {
    ...
    public void runOpMode() {
        ...
        waitForStart();//driver hits play on the robot
