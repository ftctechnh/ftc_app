...
import org.firstinspires.ftc.teamcode.ROUSAutoHardware_WithoutServos;
...
public class ROUSAutoDriveByEncoder_PurpleBlue extends LinearOpMode {   //The word Purple in the name
                                                                        ...
                                                                        // the reasoning behind using the word Purple
                                                                        // is that it is the combination of red and blue
                                                                        // signifying that both sides could use the base
                                                                        // program without changing how the program is
                                                                        // structured but changing the turn directions
                                                                        // and it was the color of this programs creator at the time
    ...
    //static final double     WheelSpace              = 18.5;
    //static final double     Pi                      = 3.1415;
    //static final double     Turn180Deg              = (WheelSpace/2) * (2*Pi) *(180/360);
    //static final double     Turn90Deg               = (WheelSpace/2) * (2*Pi) *(90/360);
    //static final double     Turn45Deg               = (WheelSpace/2) * (2*Pi) *(45/1440);
    ...
    public void runOpMode() throws InterruptedException {
         ...
         */
            ...
            sleep(1000);
            encoderDrive(DRIVE_SPEED, 16.264, -16.264, 20);  // S2: Turn 90deg to the right with 20 Sec timeout
            sleep(1000);
