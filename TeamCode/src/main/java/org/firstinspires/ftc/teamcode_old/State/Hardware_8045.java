...
//    public AnalogInput ballsensor2;
    ...
    public static final double sweeperpower   =  0.6 ;  // default power for sweeper.
    ...
    public String[] menulabel = {"Team","Mode", "Particles","Delay","Heading 0", "Distance 0","Heading 1", "Distance 1","Heading 2","Distance 2","Heading 3","Distance 3","Heading 4","Distance 4","Heading 5","Distance 5","Right Color Threshold","Left Color Threshold","SuperMode Turn Blue","SuperMode Turn Red","Pick Up Partner Ball"};

    public String[] teamname = {"Red", "Blue"};
    public String[] modename = {"Beacon Route","Ignore Me Capball","Beacon Route SUPER Mode"," Simple Capball","Simple Ramp"};
    //                                           -52,58    supermodeturnred 4

    public int[]    menuvalue = {1,0,2,0, 0,8,  -45,53,   18,-16,   0,13,   0,30   ,130,50, 121,121, -9,-7,0};
    ...
    public boolean  TeamisBlue,PickUpPartnerBall;
