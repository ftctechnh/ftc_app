...
public class HardwareOmnibot
{
    ...
    public float speed = (float) .6;
    public float turn = (float) .6;
    ...
    */
    ...
    public void init(HardwareMap ahwMap) {
        ...
        motorRightFront = hwMap.dcMotor.get("rightfront");
        motorRightRear  = hwMap.dcMotor.get("rightrear");
        motorLeftFront  = hwMap.dcMotor.get("leftfront");
        motorLeftRear   = hwMap.dcMotor.get("leftrear");
