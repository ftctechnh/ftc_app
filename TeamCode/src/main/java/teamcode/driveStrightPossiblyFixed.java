...
@TeleOp(name="driveStrightPossiblyFixed", group="Linear Opmode")

public class driveStrightPossiblyFixed extends LinearOpMode {
    //teleOPFinal
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() ) {
            ...
            if (gamepad1.atRest()) {
                ...
                robotYSpeedRight = -gamepad1.right_stick_y;
                robotXSpeedRight = gamepad1.right_stick_x/1.2;
                drive(robotXSpeedRight, robotYSpeedRight);
