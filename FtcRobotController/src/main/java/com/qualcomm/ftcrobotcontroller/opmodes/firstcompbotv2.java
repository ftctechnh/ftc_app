 ...
 */
public class firstcompbotv2 extends OpMode {
    ...
    public void loop() {
        ...
        boolean arm_power = gamepad1.dpad_up;
        boolean arm_power_one = gamepad1.dpad_down;
        boolean sweeper_power = gamepad1.left_bumper;
        boolean sweeper_power1 = gamepad1.right_bumper;
        boolean bucket_servo_power_open = gamepad1.x;
        boolean bucket_servo_power_closed = gamepad1.y;
