 ...
 */
public class CombBot implements DriverInterface
{
    ...
    public CombBot(HardwareMap hardwareMap)
    {
    ...
    public void moveStraightEncoders(float inches, float speed)
    {
        ...
        int encoderTarget = ((int)(128.5713 * inches));
        if(encoderTarget > 0)
        {
    ...
    public void pivotTurn(float degrees, float speed)
    {
        ...
        int encoderPivotTarget = ((int)(128.5713 * 98.960168 * degrees/360));
    ...
    public void spinOnCenter(float degrees, float speed)
    {
        ...
        leftMotor.setMode(DcMotorController.RunMode.RUN_USING_ENCODERS);
        rightMotor.setMode(DcMotorController.RunMode.RUN_USING_ENCODERS);
        int encoderSpinTarget = ((int)(128.5713 * 49.48 * degrees/360));
