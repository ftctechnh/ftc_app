...
public class AutoLongRight extends OpMode {
  ...
  public void loop() {
    ...
    double departDur   =  0.00 * totalTime;
    double turn1Dur    =  0.26 * totalTime;
    double straightDur =  0.32 * totalTime;
    double turn2Dur    =  0.26 * totalTime;
    double approachDur =  0.16 * totalTime;
