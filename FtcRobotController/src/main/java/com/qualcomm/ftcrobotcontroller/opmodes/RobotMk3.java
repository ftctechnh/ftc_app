 ...
 */
public class RobotMk3 extends PushBotTelemetry

{
...

    {
        ...
        if (gamepad1.left_bumper)
        {
            try
            {
                v_servo_bucket_release.setPosition(v_servo_bucket_release.getPosition()+.05);
            }
        ...
        if (gamepad1.right_bumper)
        {
            try
            {
                v_servo_bucket.setPosition(v_servo_bucket.getPosition()+.05);
            }
            catch (Exception p_exception)
            {
