...
/**
 *  Extends the OpMode class to provide a single hardware access point for the Push Bot.
 */
public class PushBotHardware extends OpMode {
    ...
    public void run_using_encoders() {
        ...
        l_mode = v_dc_motor_controller_drive.getMotorChannelMode(v_channel_right_drive);
        if (l_mode == DcMotorController.RunMode.RESET_ENCODERS) {
