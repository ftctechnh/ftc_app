 ...
 * is pressed.
 */
public class MattPushBotDriveTouchEncoders extends LinearOpMode {
    DcMotor leftMotor;
    DcMotor rightMotor;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            telemetry.addData("Encoders", " Left=" + leftMotor.getCurrentPosition() + " Right=" + rightMotor.getCurrentPosition());
