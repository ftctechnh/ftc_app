 ...
 */
public class OhmIZeusNew extends OpMode {
    ...
    Servo guard1Servo;
    double guard1Delta = 0.5;
    double guard1Position;
    final static double GUARD1_MIN_RANGE  = 0;
    final static double GUARD1_MAX_RANGE  = 1;
    ...
    public void initGuardServo(){
        ...
        guard1Servo = hardwareMap.servo.get("servo_guard1");

        guard1Position = .5;
        guard1Servo.setPosition(.5);
...
*/
    ...
    public void loopGuardServo() {
        ...
        guard1Position = Range.clip(guard1Position, GUARD1_MIN_RANGE, GUARD1_MAX_RANGE);

        //telemetry.addData("bucket Pos",bucketPosition);

        guardServo.setPosition(guardPosition);
        guard1Servo.setPosition(guard1Position);
