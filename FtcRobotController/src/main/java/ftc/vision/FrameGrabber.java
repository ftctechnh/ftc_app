...
public class FrameGrabber implements CameraBridgeViewBase.CvCameraViewListener2 {
  ...
  private ftc.vision.ImageProcessor imageProcessor = null;
  private ftc.vision.ImageProcessorResult result = null;
  ...
  public ftc.vision.ImageProcessor getImageProcessor() {
  ...
  public void setImageProcessor(ftc.vision.ImageProcessor imageProcessor) {
  ...
  public ftc.vision.ImageProcessorResult getResult(){
    return result;
  }
  ...
  private void processFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame){
    ...
    ftc.vision.ImageUtil.rotate(tmp1, frame, 90);
