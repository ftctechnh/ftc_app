...
public class BallProcessor implements ImageProcessor<BallColorResult> {
    ...
    @Override
    public ImageProcessorResult<BallColorResult> process(long startTime, Mat rgbaFrame, boolean saveImages) {
        ...
        BallColorResult.BallColor[] BallColours = BallColorResult.BallColor.values();
        BallColorResult.BallColor left = BallColours[maxMassIndex[0]];
        BallColorResult.BallColor right = BallColours[maxMassIndex[1]];
        ...
        return new ImageProcessorResult<>(startTime, rgbaFrame,
                new BallColorResult(left, right)
        );
    }
}