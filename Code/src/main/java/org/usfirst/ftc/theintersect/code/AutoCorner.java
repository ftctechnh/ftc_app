...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Auto Corner")
public class AutoCorner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(!gamepad1.start && !isStopRequested()) {
            if (gamepad1.x) {
                ...
                telemetry.addLine("NOT Confirmed");
                telemetry.update();
            }
            if (gamepad1.b) {
                telemetry.clear();
        ...
        telemetry.clear();
        telemetry.addLine(Character.toString(alliance));
        ...
        if (opModeIsActive()) {
            ...
            if(alliance == 'b') {
            driveTrain.moveBkwd(.3, 20, 3);
                autoShoot(((-0.155*voltage) + 2.459),4000,500);
                driveTrain.rotateCWGyro(150, .5, 5000, gyro, telemetry);
                driveTrain.moveBkwd(1, 20, 3);
                driveTrain.moveBkwd(1, 12, 3);
                driveTrain.moveFwd(0.3, 27, 5);
                driveTrain.moveRight(.5, 65, 5);
                driveTrain.moveFwd(.2, 1, 3);
                driveTrain.moveRight(.5, 10, 5);
                colorDriveFwd(.2, 'b', 3);
                ...
                driveTrain.moveBkwd(0.2, 19, 5);
                autoShoot(((-0.155*voltage) + 2.459),4000,500);
                driveTrain.moveBkwd(0.3, 8, 5);
                Functions.waitFor(250);
                driveTrain.moveRight(.5, 55, 5);
                driveTrain.moveBkwd(.2, 3, 3);
                driveTrain.moveRight(.5, 10, 5);
                colorDriveBkwd(.2, 'r', 2);
                driveTrain.strafeRight(1, 1500);
                pressBeacon(1500, 750);
