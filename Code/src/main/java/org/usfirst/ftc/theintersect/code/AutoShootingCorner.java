...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Auto Shooting Corner")
public class AutoShootingCorner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            if(alliance == 'b') {
                ...
                driveTrain.strafeLeft(.3,23,3);
                driveTrain.moveBkwd(0.2, 19, 5);
                autoShoot(((-0.155*voltage) + 2.459),4000,500);
                driveTrain.moveFwd(0.3, 8, 5);
                driveTrain.moveLeft(.5, 55, 5);

            } else if( alliance == 'r'){
                Functions.waitFor(10000);
                driveTrain.strafeRight(.3, 23, 3);
                driveTrain.moveBkwd(0.2, 19, 5);
                autoShoot(((-0.155*voltage) + 2.459),4000,500);
                driveTrain.moveFwd(0.3, 8, 5);
