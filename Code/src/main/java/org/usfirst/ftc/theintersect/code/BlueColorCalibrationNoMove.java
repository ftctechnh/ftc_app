...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Blue Color Calibration No Move")
public class BlueColorCalibrationNoMove extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            if(detectBlue(beaconColor)){
                pressBeacon(1000,750);
                telemetry.clear();
