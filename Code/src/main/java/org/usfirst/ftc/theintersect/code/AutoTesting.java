...
public class AutoTesting extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(!gamepad1.start && !isStopRequested()) {
            ...
            telemetry.addData("Max", gyroRampMax);
        ...
        while (opModeIsActive() ) {
            ...
            if ( gamepad1.start ) {
//                driveTrain.rotateCWGyroRamp(90, speed, 10, gyro, telemetry);
                driveTrain.rotateGyroRamp(rotateAngle, speed, 10, gyro, telemetry);
//                driveTrain.rotateGyroRamp(rotateAngle, speed, 10, telemetry);
            }
            // waitFor(2000);
        }
    }
