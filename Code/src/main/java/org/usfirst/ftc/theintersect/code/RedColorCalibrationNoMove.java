...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Red Color Calibration No Move")
public class RedColorCalibrationNoMove extends LinearOpMode {
